...
HTTPD_ARCHIVE="httpd-${HTTPD_VERSION}-o111f-x64-vc15.zip"
MYSQL_ARCHIVE="mysql-${MYSQL_VERSION}-winx64.zip"
PHP_ARCHIVE="php-${PHP_VERSION}-Win32-vc15-x64.zip"

FILE_ARCHIVE_SHA256_CHECKSUMS=(
  [$HTTPD_ARCHIVE]="1bc0710222859ae84956753bd1f4ee0a49e503ce70bf2f6deb82d8f9f3dd81be"
  [$MYSQL_ARCHIVE]="e36d107c57b8382272396802d56564efa6f59b51cc011e1c5a05761b7157e74d"
  [$PHP_ARCHIVE]="2822fec309cb89f6775fbf2516497cdbaa91c9842f520e127c9e83cfa38c43e9"
)
